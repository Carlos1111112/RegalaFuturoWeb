        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/impacto" className="hover:text-primary-400 transition-colors">Impacto y Transparencia</Link></li>
              <li><Link href="/preguntas" className="hover:text-primary-400 transition-colors">Preguntas Frecuentes</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/donar" className="hover:text-primary-400 transition-colors">Donar</Link></li>
              <li><Link href="/solicitar-apoyo" className="hover:text-primary-400 transition-colors">Solicitar Apoyo</Link></li>
              <li><Link href="/eventos-voluntariado" className="hover:text-primary-400 transition-colors">Voluntariado</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <span>contacto@regalafuturo.org</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
